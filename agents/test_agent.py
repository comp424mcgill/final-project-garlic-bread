...
class TestAgent(Agent):
    ...
    def __init__(self):
        ...
        self.opposites = {0: 2, 1: 3, 2: 0, 3: 1} # opposite moves as defined in world.py
    ...
    def get_valid_steps(self, chess_board, my_pos, adv_pos, max_step): # returns set (can change to list if necessary) of valid steps from current position
        ...
        for end_pos in end_posits:
            valid_steps.append(tuple((end_pos[0],end_pos[1],0)))
            valid_steps.append(tuple((end_pos[0],end_pos[1],1)))
            valid_steps.append(tuple((end_pos[0],end_pos[1],2)))
            valid_steps.append(tuple((end_pos[0],end_pos[1],3)))
